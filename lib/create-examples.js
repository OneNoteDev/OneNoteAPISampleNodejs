...
var CreateExamples = function () {
    ...
    this.createPageWithSimpleText = function (accessToken, callback) {
        var htmlPayload =
            "<!DOCTYPE html><html><head><title>A page created from basic HTML-formatted text (Node.js Sample)</title><meta name=\"created\" value=\"" + dateTimeNowISO() + "\"/></head><body><p>This is a page that just contains some simple <i>formatted</i> <b>text</b></p></body></html>";
    ...
    this.createPageWithTextAndImage = function (accessToken, callback) {
        var htmlPayload =
            "<!DOCTYPE html><html><head><title>A page created containing an image (Node.js Sample)</title><meta name=\"created\" value=\"" + dateTimeNowISO() + "\"/></head><body><p>This is a page that just contains some simple <i>formatted</i> <b>text</b> and an image</p><img src=\"name:ImageData\" alt=\"A beautiful logo\" width=\"426\" height=\"68\" /></body></html>";
    ...
    this.createPageWithScreenshotFromUrl = function (accessToken, callback) {
        var htmlPayload =
            "<!DOCTYPE html><html><head><title>A page created with a URL snapshot on it (Node.js Sample)</title><meta name=\"created\" value=\"" + dateTimeNowISO() + "\"/></head><body><img data-render-src=\"http://www.onenote.com\" alt=\"An important web page\" />Source URL: <a href=\"http://www.onenote.com\">http://www.onenote.com</a></body></html>";
    ...
    this.createPageWithFile = function (accessToken, callback) {
        var htmlPayload =
            "<!DOCTYPE html><html><head><title>A page with a file on it (Node.js Sample)</title><meta name=\"created\" value=\"" + dateTimeNowISO() + "\"/></head><body><object data-attachment=\"OneNote Logo.jpg\"data=\"name:EmbeddedFile\"type=\"image/jpeg\"</body></html>";
